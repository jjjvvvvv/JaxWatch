#!/usr/bin/env python3
"""
Document Verifier - JaxWatch Document Verification Tool
...
Usage:
    python document_verifier.py <command> [options]
...
Examples:
    python document_verifier.py demo
    python document_verifier.py document_verify
    python document_verifier.py document_verify --active-year 2026
    python document_verifier.py document_verify --project DIA-RES-2025-12-03 --force
